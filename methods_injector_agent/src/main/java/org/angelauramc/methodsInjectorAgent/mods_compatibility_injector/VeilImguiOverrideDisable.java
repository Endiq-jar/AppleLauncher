        ...
        public MethodVisitor visitMethod(int access, String name, String desc, String signature, String[] exceptions) {
            ...
            if (name.equals("setImGuiPath")
                ...
                try { // Minecraft makes it ugly if we use println
                    System.out.write(("Apple Launcher: Patching VeilImGuiImpl for faulty setImGuiPath()...\n" +
                            ...
                            "The intended target of this patch is Veil 3.1.0 and below. If you see this log output without Veil 3.1.0 or lower running, please send a bug report on our Discord.\n" +
                            "https://discord.gg/QDcnQj28D3").getBytes());
