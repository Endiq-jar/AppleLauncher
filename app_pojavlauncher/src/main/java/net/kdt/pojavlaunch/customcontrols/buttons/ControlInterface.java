            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                switch (event.getActionMasked()) {
                    ...
                    case MotionEvent.ACTION_MOVE:
                        ...
                        // Force a full redraw of the parent every frame while dragging.
                        // Without this, the elevated/shadowed button can leave a trail of
                        // stale composited frames behind it as it moves (view elevation +
                        // rapid setX/setY doesn't always trigger a complete parent redraw).
                        View dragParent = (View) getControlView().getParent();
                        if (dragParent != null) dragParent.invalidate();
                        break;
                }
