...
public class ModInstallFragment extends Fragment {
    ...
    private void showProfileSelectorAndDownload(String url, String fileName) {
        ...
        for (int i = 0; i < validNames.size(); i++) {
            ...
            span.setSpan(new android.text.style.ForegroundColorSpan(0xFFFF5252), 0, rawText.length(), android.text.Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
            displayItems[i] = span;
        }
    ...
    private void downloadMod(Context ctx, String url, String fileName,
        ...
        if (!targetDir.exists()) {
            ...
            if (created) Log.d("AppleLauncher", "Created directory: " + targetDir.getAbsolutePath());
        }
