...
public class JREUtils {
    ...
    public static void relocateLibPath(Runtime runtime, String jreHome) {
        ...
        String nativesLwjglVersion = Tools.sLwjglVersion != null ? Tools.sLwjglVersion : "3.3.3";
        ldLibraryPath.append(String.format(":%s/lwjgl-%s-natives/%s", Tools.DIR_DATA, nativesLwjglVersion, archAsStringAndroid(getDeviceArchitecture())));
