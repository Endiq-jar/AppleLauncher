        ...
        post(()->{
            if(tc > 0) {
                ...
                if (mPercentageText != null) {
                    mPercentageText.setTextColor(0xFFFF5252);
                }
                ...
                if (getVisibility() == VISIBLE && !mIsFinishing) {
                    ...
                    if (mStatusText != null) {
                        ...
                        mStatusText.setTextColor(0xFFFF5252); // accent (Crimson)
                    }
                    if (mPercentageText != null) {
                        mPercentageText.setText("100%");
                        mPercentageText.setTextColor(0xFFFF5252); // accent (Crimson)
                    }
                    if (mProgressBar != null) {
                        mProgressBar.setProgress(100);
                        mProgressBar.setProgressTintList(ColorStateList.valueOf(0xFFFF5252));
                    }
                    if (mDetailText != null) {
